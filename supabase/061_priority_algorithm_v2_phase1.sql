-- Priority Algorithm v2 Phase 1.
--
-- Preserves the Migration 056 Cram branch byte-for-byte while refining only
-- Normal Priority Mode with a transient fresh-Forgot priority contribution and
-- response-aware question difficulty targeting. Learner-state evidence
-- coefficients, eligibility, cooldowns, angle selection, and persistence remain
-- unchanged.
