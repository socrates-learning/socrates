-- Phase 6B: prerequisite-aware official priority in Normal Mode only.
--
-- Preserves the Migration 065 selector, including the complete Cram branch,
-- eligibility, history, angle, difficulty, cooldown, and traversal semantics.
-- The only ranking change is one bounded prerequisite component added to the
-- official Normal Mode Concept score.
