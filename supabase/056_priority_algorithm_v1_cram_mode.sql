-- Priority Algorithm v1 Cram Mode selection.
--
-- Adds a separate Cram branch to the existing selector. Normal Priority Mode
-- scoring remains identical to migration 055.
