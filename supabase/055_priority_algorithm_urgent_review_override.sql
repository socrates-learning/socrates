-- Narrow Priority Algorithm v1 correction: urgent review can override the New extreme.
--
-- The selector is otherwise identical to migration 054. Only the maximum
-- urgent-review contribution changes from 0.20 to 0.30.
